...
Ensure devtools is installed. If not installed, run install.packages("devtools") to install it. You can install the development version of B2Prebake like so:
